...
username = str(base64.b64encode(b"3032804560@qq.com"),encoding='UTF-8') # 输入自己的用户名对应的编码
password = str(base64.b64encode(b"vweszyrdkuotdgbj"),encoding='UTF-8')  # 此处不是自己的密码，而是开启SMTP服务时对应的授权码
...
# 编辑邮件信息，发送数据
subject = "ShaderLab Registration"
